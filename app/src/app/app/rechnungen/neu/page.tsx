    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Zuerst als Entwurf speichern, dann festschreiben (Nummer, PDF,
          Buchungsjournal).
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Positionen und Kopfdaten sind editierbar, bis die Rechnung
            festgeschrieben wird. Die Rechnungsnummer wird erst bei der
            Festschreibung vergeben.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <RechnungForm
            action={createRechnungAction}
