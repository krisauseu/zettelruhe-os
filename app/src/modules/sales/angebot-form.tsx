...
import type { AngebotMitPositionen } from "./types";
...
type Props = {
  ...
  error?: string | null;
  angebot?: AngebotMitPositionen | null;
  mode: "create" | "edit";
};
...
export function AngebotForm({
  ...
  return (
    <form action={action} className="flex flex-col gap-6">
      {angebot ? <input type="hidden" name="id" value={angebot.id} /> : null}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          />
          <p className="text-xs text-muted-foreground">
            Leer = Angebotsdatum + 30 Tage.
          </p>
        </div>
      </div>

      <div className="flex flex-col gap-1.5">
        <Label htmlFor="notiz">Notiz / Hinweis auf dem Angebot</Label>
        <Textarea
          id="notiz"
          name="notiz"
          rows={2}
